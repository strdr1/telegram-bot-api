    ...
    try:
        ...
        if any(word in message_lower for word in ['калори', 'ккал']):
            ...
            if not is_specific_dish:
                # Это вопрос про калории в категории - показываем список с вопросом
                if 'пицц' in message_lower:
                    logger.info(f"🔍 Обнаружен вопрос про калории в пицце - показываем список")
                    return {
                        'type': 'text',
                    ...
                    logger.info(f"🔍 Обнаружен вопрос про калории в супах - показываем список")
                    return {
                        'type': 'text',
