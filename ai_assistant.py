...
async def get_ai_response(message: str, user_id: int) -> Dict:
    ...
    try:
        ...
        system_prompt = (
            ...
            f"Если пользователь ищет блюда не по категории, а по ИНГРЕДИЕНТАМ или ТИПУ (например: 'с овощами', 'мясное', 'без мяса', 'веганское', 'острое', 'с грибами') - ИСПОЛЬЗУЙ МАРКЕР SEARCH:запрос\n"
            f"ПРИМЕРЫ:\n"
            ...
            f"НЕ ИСПОЛЬЗУЙ PARSE_CATEGORY, если такой категории нет в списке! Используй SEARCH!\n"
