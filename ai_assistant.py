...
"СПЕЦИАЛЬНО ДЛЯ МОРЕПРОДУКТОВ: Если пользователь спрашивает 'что посоветуешь', 'а другие', 'еще' или 'что заказать' и в истории недавно (последние 3-5 сообщений) было упоминание морепродуктов ('морепродукты', 'креветки', 'мидии', 'кальмар', 'осьминог', 'гребешк', 'краб', 'рыба'), ОБЯЗАТЕЛЬНО предлагай блюда из категории МОРЕПРОДУКТЫ или используй SEARCH:креветк, кальмар, миди, осьминог, гребешк, краб. НЕ ПРЕДЛАГАЙ мясо или десерты, если контекст про морепродукты!\n\n"
